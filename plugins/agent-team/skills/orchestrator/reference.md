...
| 調査系（Read 専用） | `"auto"` | 不要 | 書き込みは artifacts/ のみ。破壊的操作は確認される |
| Red-Team / QA-Manager | `"auto"` | 不要 | Read 専用。artifacts/ への書き込みのみ |
| 統合系（Chief of Staff） | `"auto"` | 不要 | git merge + artifacts/chief-of-staff/ 書き込みのみ |

> **重要**: `mode` を指定しない場合、チームメイトは `default` モードで動作し、全ツール使用でユーザー確認が発生して自律作業が阻害される。必ず指定すること。
...
|---|---|---|---|---|---|
| Chief of Staff | 最初（全体を通じて稼働） | L1 | 統合系 | `"auto"` | 不要 |
| リサーチャー | 1番目 | L1 | 調査系 | `"auto"` | 不要 |
| アーキテクト | 2番目（リサーチャー完了後） | L1 | 調査系 | `"auto"` | 不要 |
| フロントエンジニア | 3番目（並列） | L1 | 実装系 | `"bypassPermissions"` | `"worktree"` |
| バックエンジニア | 3番目（並列） | L1 | 実装系 | `"bypassPermissions"` | `"worktree"` |
| Red-Team | 4番目 | L1 | 調査系 | `"auto"` | 不要 |
| QA-Manager | 5番目 | L1 | 調査系 | `"auto"` | 不要 |
...
|---|---|---|---|---|---|
| Chief of Staff | 最初（全体を通じて稼働） | L1 | 統合系 | `"auto"` | 不要 |
| アナリスト | 1番目 | L1 | 調査系 | `"auto"` | 不要 |
| バグフィクサー | 2番目（アナリスト完了後） | L1 | 実装系 | `"bypassPermissions"` | `"worktree"` |
| Red-Team | 3番目 | L1 | 調査系 | `"auto"` | 不要 |
| QA-Manager | 4番目 | L1 | 調査系 | `"auto"` | 不要 |
...
|---|---|---|---|---|---|
| リサーチャー | 1番目 | L1 | 調査系 | `"auto"` | 不要 |
| テクニカルライター | 2番目 | L1 | 調査系 | `"auto"` | 不要 |
| QA-Manager | 3番目 | L1 | 調査系 | `"auto"` | 不要 |
